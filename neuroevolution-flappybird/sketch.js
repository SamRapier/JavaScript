...
function preload() {
  // let data = loadJSON("https://raw.githubusercontent.com/SamRapier/JS-NeuralNetwork/master/neuroevolution-flappybird/bestBird.json", gotData);
}
...
function draw() {
  ...
  if (!runBest) {
    ...
    if (activeBirds.length > 0){
      let s = activeBirds[0].score;
      if (s > tempHighScore) {
        tempHighScore = s;
        tempBestBird = activeBirds[0];
      }
    }
  ...
  // saveJSON(allTimeHighScoreSpan, 'bestBird.json');
